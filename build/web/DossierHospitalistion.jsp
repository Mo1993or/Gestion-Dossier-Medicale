        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <th colspan="2" scope="col">Numeros Chambre</th>
                    <th colspan="2" scope="col">Numeros Lit</th>
                ...
                <c:forEach var="lho" items="${listerHos}">
                    <tr>
                        <th colspan="2" scope="col">${lho.description}</th> 
                        <th colspan="2" scope="col">${lho.date}</th>
                        <th colspan="2" scope="col">${lho.numeroChambre}</th>
                        <th colspan="2" scope="col">${lho.numeroLit}</th>
                        <th colspan="2" scope="col"></th>
                        <th colspan="2" scope="col">
                            <c:url var="delUrlh" value="controleur">
                                <c:param name="action" value="supprimerHos"/> 
                                <c:param name="idhos" value="${lho.idHospitalisation}"/>
                                <c:param name="idhh" value="${idus.noUser}"/>
                            </c:url>
                            <a href="javascript:confirmDelete('${delUrlh}')"><img src='del.png' width='15' /></a></th>
                    </tr>
                </c:forEach>
                <tr>
                    <th colspan="2" scope="col"></th> 
                    ...
                    <th colspan="2" scope="col"></th>
                    <th colspan="2" scope="col"></th>
                    <th colspan="2" scope="col"><a href='controleur?action=AjoutHos&idso=${dex.idDossier}' ><img src='pen.png' width='15' /></a></th>
                    <th colspan="2" scope="col"></th>
                </tr>          
            </tbody>  
