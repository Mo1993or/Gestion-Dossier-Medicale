...
<html lang="en">
  ...
  <body>
      ...
      <input type="hidden" name="action" value="enrcmpad"/>    
      
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Prenom:</label>
    <div class="col-sm-10">
        <input type="hidden" name="idcmpad" value="${ud.noUser}"/>    
        <input type="text" class="form-control" id="inputPassword3" name="Prenom" value="${ud.prenom}">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Nom:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" name="Nom" value="${ud.nom}">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" name="Email" value="${ud.email}">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Mot de passe</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3"  name="password" value="${ud.password}" >
    </div>
  </div>
