        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <th colspan="3" scope="col">Date vaccin</th>
                    <th colspan="3" scope="col">Modifier</th>
                    <th colspan="3" scope="col">Supprimer</th>

                </tr>
                <c:forEach var="lv" items="${listerVacc}">
                    <tr>
                        <th colspan="3" scope="col">${lv.description}</th> 
                        <th colspan="3" scope="col">${lv.dateVaccin}</th> 
                        <th colspan="3" scope="col"></th> 
                        <th colspan="3" scope="col">      
                            <c:url var="delUrlv" value="controleur">
                                <c:param name="action" value="supprimerVacc"/> 
                                <c:param name="idva" value="${lv.idVacc}"/>
                                <c:param name="ivu" value="${idus.noUser}"/>
                            </c:url>
                            <a href="javascript:confirmDelete('${delUrlv}')"><img src='del.png' width='15' /></a></th>
            ...
            <tr>
                <th colspan="3" scope="col"></th> 
                <th colspan="3" scope="col"></th> 
                <th colspan="3" scope="col"><a href='controleur?action=AjoutVacc&idov=${dex.idDossier}' ><img src='pen.png' width='15' /></a></th>
                <th colspan="3" scope="col"></th> 
            </tr>
            </tbody>    
