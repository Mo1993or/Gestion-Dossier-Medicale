...
<html lang="en">
  ...
  <center>
      <div class="conntenu col-lg-5" >
          <center>   <u><h1>Formulaire Vaccination</h1></u></center>
    
      <form name="formule" class="form-horizontal" action="controleur" methode="POST">
      <input type="hidden" name="action" value="Enrvacc"/>  
      <input type="hidden" name="idovv" value="${idov}"/>  
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default" style="background-color: blue;color: white" onclick="redirection();" >Enregister</button>
    </div>
  </div>
</form>
