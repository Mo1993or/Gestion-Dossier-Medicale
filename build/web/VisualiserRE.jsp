...
<html>
            ...
            <div class="row">
                ...
                <div class="conntenu col-lg-5" >
                    ...
                    <form name="formule" class="form-horizontal" action="controleur" methode="POST">
                        <input type="hidden" name="action" value="rechercheRE"/>
                        <input type="hidden" name="rex" value="rx"/>

                        <div class="form-group">
                            <label>Veuillez choisir la mode de recherche</label>
                            <div class="col-sm-10">
                                <input type="radio"   name="rechre" value="pre" >prenom</br>
                                <input type="radio"   name="rechre" value="nre" >nom</br>
                                <input type="radio"   name="rechre" value="cnire" >CNI</br>
    ...
    <label >Rechercher </label>
      ...
      <input type="text" class="form-control"  name="rechRe" style="width: 150px;height: 52px">
    ...
    <center>
        ...
        <c:if test="${!empty listerPatientr && !empty rexxx}">
                ...
                <tbody>
                    <c:forEach var="pa" items="${listerPatientr}"> 
                        <tr>
                            ...
                            <td><a href='controleur?action=visualiserre&iddm=${pa.noUserp}' ><img src='oeil.jpg' width='25' /></a></td>
                        </tr>
