...
<html lang="en">
  ...
  <body>
     ...
     <center>
      ...
      <input type="hidden" name="action" value="enrp"/>    
      
  <input type="hidden" name="idpp" value="${p.idprofil}"/>    
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Nom profil:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" name="nomProfil" value="${p.nomProfil}">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
   ...
   <script language= "JavaScript">
	...
	if (document.formule.action.value == "enrp"){
