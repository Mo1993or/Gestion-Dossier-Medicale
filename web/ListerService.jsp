...
function confirmDelete(delUrl) 
  ...
  <tbody>
       <c:forEach var="srv" items="${listeserv}"> 
    <tr>
      <th scope="row">${srv.nomService}</th>
      <th >${srv.domaine}</th>
     <td><a href='controleur?action=modifiers&ids=${srv.idService}' ><img src='pen.png' width='15' /></a></td>
      <td>
            <c:url var="delUrl" value="controleur">
          <c:param name="action" value="supprimers"/> 
          <c:param name="idss" value="${srv.idService}"/> 
      </c:url> 
