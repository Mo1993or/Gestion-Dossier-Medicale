...
<html lang="en">
  ...
  <body>
      ...
      <div class="conntenu col-lg-5" >
          <center>   <u><h1>Formulaire Antecedent</h1></u></center>
    
      <form name="formule" class="form-horizontal" action="controleur" methode="POST">
      <input type="hidden" name="action" value="Enrant"/>  
      <input type="hidden" name="idusu" value="${iddusu.idDossier}"/> 
      <input type="hidden" name="idddusu" value="${iddds}"/> 
 ...
 <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Description" name="descrip">
    </div>
  </div>
