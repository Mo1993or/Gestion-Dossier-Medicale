...
#pasaffiche
 {
    ...
    <body>
        <div class="Nom"  >
            <div class="bt">
                <div class="linkkda">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="nav-link active" id="pasaffiche"style="color: black" data-toggle="pill" href="controleur?action=accueilacp" role="tab" aria-controls="v-pills-home">Accueil</a>
            ...
            <form name="formule">
                <button type="submit" id="pasaffiche" name="actionn" value="impp" class="btn btn-default" style="background-color: blue;color: white" onclick="imprimer();" >Imprimer</button>
            </form>
        </div>
    ...
    <script language= "JavaScript">
        ...
        function imprimer() {
            if (document.formule.actionn.value == "impp") {
