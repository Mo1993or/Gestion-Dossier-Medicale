...
<html>
            ...
            <div class="row">
                ...
                <div class="conntenu col-lg-5" >
                    ...
                    <form name="formule" class="form-horizontal" action="controleur" methode="POST">
                        <input type="hidden" name="action" value="recherchehos"/>
                        <input type="hidden" name="rho" value="rhh"/>

                        <div class="form-group">
                            <label>Veuillez choisir la mode de recherche</label>
                            <div class="col-sm-10">
                                <input type="radio"   name="rechos" value="pros" >prenom</br>
                                <input type="radio"   name="rechos" value="nros" >nom</br>
                                <input type="radio"   name="rechcos" value="cnios" >CNI</br>
    ...
    <label >Rechercher </label>
      ...
      <input type="text" class="form-control"  name="rechhos" style="width: 150px;height: 52px;height: 52px">
    ...
    <center>
        ...
        <c:if test="${!empty listerPatientr && !empty rhooo}">
                ...
                <tbody>
                    <c:forEach var="pa" items="${listerPatientr}"> 
                        <tr>
                            ...
                            <td><a href='controleur?action=visualiserdh&iddm=${pa.noUserp}' ><img src='oeil.jpg' width='25' /></a></td>
                        </tr>
