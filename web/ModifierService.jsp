...
<html lang="en">
  ...
  <body>
     ...
     <center>
      ...
      <input type="hidden" name="action" value="modiser"/>    
   <input type="hidden" name="idser" value="${se.idService}"/>
   
    <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Nom Service:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Description" name="nomService" value="${se.nomService}">
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="domaine" name="domaine" value="${se.domaine}">
    </div>
  </div>
